...
public class OrderInfoPresenter extends BasePresenter<OrderInfoBean> {
    ...
    //subject:支付的原因
    //price:支付的价格
    public void addParams(String subject, String totalPrice, List<ShopCartBean.ShopcarData> shopcarDataList) {
        JSONArray jsonArray = new JSONArray();
        //用数组来存储购买的产品信息,使用JsonArray，是因为可能购买多个产品
        JSONObject object = new JSONObject();
        for(ShopCartBean.ShopcarData shopcarData:shopcarDataList) {
            try {
