    ...
    public void init(final Context context) {
        ...
        context.bindService(intent, new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ShopMoreService.ShowMoreBinder shopMallBinder = (ShopMoreService.ShowMoreBinder)service;
                ShopMoreService shopMallService = shopMallBinder.getServices();
                String token = SpUtil.getTpken(context);
                if (token!=null)
                shopMallService.autoLogin(token, new ShopMoreService.IAutoLoginListener() {
                    @Override
