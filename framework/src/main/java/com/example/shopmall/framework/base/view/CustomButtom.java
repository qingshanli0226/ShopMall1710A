...
public class CustomButtom extends LinearLayout implements RadioGroup.OnCheckedChangeListener {
    ...
    private List<ButtomBean> bottomBeans;
    public void setViewPager(ViewPager viewPager) {
        this.viewPager = viewPager;
    }

    public void setBottomBeans(List<ButtomBean> bottomBeans) {
    ...
    private void initView(Context context) {
        LayoutInflater.from(context).inflate(R.layout.layout_custombutton,this);
