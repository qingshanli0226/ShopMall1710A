package com.example.shopmall.shopmall1710a.fragment.type.adapter;
...
import com.example.shopmall.common.DensityUtil;
...
public class TypeRightAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TypeRightAdapter(Context mContext, List<TypeBean.ResultBean.ChildBean> child,List<TypeBean.ResultBean.HotProductListBean> hot_product_list) {
            ...
            for (int i = 0; i < hot_product_list.size(); i++) {
                ...
                myLinear.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("productImageUrl", figure);
                        intent.putExtra("productPrice",cover_price);
